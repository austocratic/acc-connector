...
const chargeDisputeFundsReinstated = async req => {
    console.log('Info: called event/stripe/chargeDisputeFundsReinstated controller');
    ...
    if (stripeCharge.metadata === null || stripeCharge.metadata.repair_id === undefined){
        ...
        throw `charge.dispute.funds_reinstated for a charge ${stripeCharge.id} that has no repair ID`
    }
